...
module Responses
  ...
  def self.generate_response(note)
    ...
    generate_openai_response(note) || "Hmm, that sounds interesting. What else?"
  end

  def self.generate_openai_response(note)
    ...
    response = client.chat(
      parameters: {
        model: "gpt-4o",
        messages: [
          { role: "user", content: "you are a helpful rubber ducky. please provide short and concise insight without giving me the answer." },
